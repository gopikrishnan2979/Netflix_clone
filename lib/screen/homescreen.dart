    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: SingleChildScrollView(
              child: ValueListenableBuilder(valueListenable: pageviewlist,builder: (context, value, child) {
            return Column(
...
// Future<Map<String, dynamic>> waiting(String apikey) async {
//   Getalltrending trendinglist = await getalltrending(apikey);
//   PopularMoviesList popularlist = await getallPopularmovies(apikey);
